...
class NativeArchive
{
  public:
      ...
      static int doImportFile(const QString &xmlFile);
  ...
  private:
      ...
      static bool importIPEncoderFile(const ImportItem &importItem);
      static bool importHDPVR2File(const ImportItem &importItem);
      static bool importIntensityProFile(const ImportItem &importItem);
      static bool importMagewellFile(const ImportItem &importItem);
};
