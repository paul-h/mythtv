...
ArchiveSettings::ArchiveSettings()
{
    ...
    GroupSetting* importFileSetings = new GroupSetting();
    importFileSetings->setLabel(ArchiveSettings::tr("MythArchive Import File Settings"));
    importFileSetings->addChild(MythArchiveGetRecordingList());
    importFileSetings->addChild(MythArchivePlayFileCommand());
    importFileSetings->addChild(MythArchiveRecordFileCommand());
    importFileSetings->addChild(MythArchiveReEncodeFileCommand());
    importFileSetings->addChild(MythArchiveRegularFilenameTemplate());
    importFileSetings->addChild(MythArchiveSeriesFilenameTemplate());
    importFileSetings->addChild(MythArchiveMovieFilenameTemplate());
    addChild(importFileSetings);
}
